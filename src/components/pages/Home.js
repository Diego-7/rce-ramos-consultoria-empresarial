    ...
    return(
      ...
      <Container>
        <Row className={styles.homeGrid1}>
          ...
          <a href="#"><img src={grid1} alt="Análise de negócios" /></a><br />
          <a href="#"> <p>Análise de mercado</p></a><br />
          <span>Melhore os resultados e ganhe agilidade nos negócios com ações baseadas em dados e análises.</span><br />
          <a href="#">Saiba mais</a>
          </Col>
          <Col className={styles.gridItem}>
          <a href="#"><img src={grid2} alt="Estratégia de cliente" /></a><br />
          <a href="#"> <p>Estratégia de cliente</p></a><br />
          <span>Conheça seu cliente, seus comportamentos, desejos e espectativas, com uma estratégia testada e aprovada.</span><br />
          <a href="#">Saiba mais</a>
          </Col>
          <Col className={styles.gridItem}>
          <a href="#"><img src={grid3} alt="e-comerce" /></a><br />
          <a href="#"> <p>Integração ao e-comerce</p></a><br />
        ...
        <Row className={styles.homeGrid1}>
          <Col className={styles.gridItem}>
          <a href="#"><img src={grid4} alt="Treinamento profissional" /></a><br />
          <a href="#"> <p>Treinamento profissional</p></a><br />
          <span>Tenha acesso aos melhores cursos do mercado para toda sua equipe.</span><br />
          <a href="#">Saiba mais</a>
          </Col>
          <Col className={styles.gridItem}>
          <a href="#"><img src={grid5} alt="Gestão de processos" /></a><br /> 
          <a href="#"> <p>Gestão de processos</p></a><br />
          <span>Nosso objetivo é proporcionar uma completa e abrangente melhoria operacional e financeira.</span><br />
          <a href="#">Saiba mais</a>
          </Col>
          <Col className={styles.gridItem}>
          <a href="#"><img src={grid6} alt="Produtividade e otimização" /></a><br />
          <a href="#"> <p>Produtividade e otimização</p></a><br />
